...
<tr><th>Drug Name: </th><td><input type=text STYLE='color: black;  background-color: white;' name='drug_name'></td></tr>
...
<tr><th>Drug Amount: </th><td><input type=text STYLE='color: black;  background-color: white;' name='drug_amount'></td></tr>
<tr><th>Drug Process (how long they are in a Comer for): </th><td><input type=text STYLE='color: black;  background-color: white;' name='drug_timetake'></td></tr>
<tr><th>Drug Percent (affectness) (must be over 10): </th><td><input type=text STYLE='color: black;  background-color: white;' name='drug_rand' value='10' maxlength='8'></td></tr>
<tr><th>How long it takes to grow: </th><td><input type=text STYLE='color: black;  background-color: white;' name='drug_growdays'></td></tr>
<tr><th>Drug Premade Price: </th><td><input type=text STYLE='color: black;  background-color: white;' name='drug_premadeprice'></td></tr>
<tr><th>Drug Available: </th><td><input type='checkbox' name='drug_available' value='1'></td></tr>
<tr><th>Drug Hospital Time: </th><td><input type=text STYLE='color: black;  background-color: white;' name='drug_hospital'></td></tr>
<tr><td colspan=2><input type='submit' STYLE='color: black;  background-color: white;' value='Create Drug' class='btn'></td></tr>
</form></table>
";
}
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Delete Drug' class='btn'></form>";
}
} else {
print "You have a invalid command!<br />
Ask this feature to be made by Ikz... The creator :P";
}
}
$h->endpage();
?>
