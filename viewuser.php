...
include "globals.php";//Get the married persons data
...
if($r['donatordays']) { $r['username'] = "<font color=aqua>{$r['username']}</font>";$d="<img src='donator.gif' alt='Donator: {$r['donatordays']} Days Left' title='Donator: {$r['donatordays']} Days Left' />"; }
if($r['laston'] >= time()-30*60) { $on="images/online.png"; }  else { $on="images/offline.png"; }
if($r['laston'] >= time()-30*60) { $status="Online"; } else { $status="Offline"; }
print "

<div class='icolumn2' id='mainContentDiv'>

<div class='gangpage_container' style='margin-left:0px;'>
<!-- Member Profile Page Starts --><!-- Member Content Part Starts -->
<div class='mem_conpart1'>
<div class='mem_conpart1_left'>
<div class='con_txt1'>
<div class='online_btn'> <img src='$on' alt='$status' title='$status' style='float: left'  /><h2>{$r['username']} <span>[{$r['userid']}] $d </span></h2> </div>
</div><div class='respart'>

<div class='resimg_bg' style='padding-top:1px;position:relative;'>
...
<div class='cap_txtpart'>
    <div class='cap_txt1'>Enemies:</div><div class='cap_txt2'>{$r['enemy_count']}</div>

</div>

 <div class='cap_txtpart'>
    <div class='cap_txt1'>Referals:</div>
    <div class='cap_txt2'>$referal
</div></div><div class='cap_txtpart'>
    <div class='cap_txt1'>Married to:</div>";if($r['married'] > 0)
{
...
<div class='mem_gangtxt'  style='padding-left: 85px;'><img src='images/mem_gangtxt.png' alt='' style=';'/></div>
...
if($r['gang'])
{
print " <a style='color:#fff;' href='gangs.php?action=gang_view&gang_id={$r['gang']}'>{$r['gangNAME']} </a> ";
}
else
{
print "N/A";
...
<div style='center' class='useraction_txt'><img src='images/useraction_txt.png' alt='' /></div>
<div class='user_imgpart'>
    <div class='user_leftimgpart'>

        <div class='user_leftimg1'> <div align='left'> <a href='sendcash.php?ID={$r['userid']}'>Send Cash</a></div> </div> <div class='user_leftimg2'> <div align='left'> <a href='sendcrys.php?ID={$r['userid']}'>Send Crystals</a></div> </div> <div class='user_leftimg3'>  <div align='centre'> <a href='attack.php?ID={$r['userid']}'>Attack</a>
</div></div>
<div class='user_leftimg4'><div align='left'><a href='friendslist.php?action=add&ID={$r['userid']}'>Add Friend</a></div></div><div class='user_rightimg5'><div align='left'><a href='mailbox.php?action=compose&ID={$r['userid']}'>Mail User</a></div></div>
    </div>
