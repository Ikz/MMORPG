...
<div class='pref_txt2'>Signature (you may use HTML):<br/>(500 Chars Max)</div>
</div>
...
";
if($ir['married']) { print "<a href='preferences.php?action=marriage'>Marriage Allowance Change</a><br />"; }
print "
...
if($r['donatordays']) { 
print "<a href='http://preferences.php?action=colorchange' target='_blank'>Change Name Color</a>"; }
...
<option value='red'><font color=none>None</font> 
