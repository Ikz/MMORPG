...
$db->query("UPDATE users SET cybermoney=cybermoney+(cybermoney/100*2) where cybermoney>0");
$db->query("UPDATE users SET donatormoney=donatormoney+(donatormoney/100*3) where donatormoney>0");
...
$db->query("UPDATE users SET dailyvip=0");
$db->query("UPDATE users SET lockers=0");
$db->query("UPDATE users SET lockersdone=0");
?>
