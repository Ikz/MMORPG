...
function add_game()
{
  ...
  if(!isset($_POST['amt']))
  {
    echo "<big>Adding a game</big>
      ...
      <input type='submit' value='Add!'></form>($maxg games max per user)<a href='C5050.php'>Back</a>";
  }
  else
  {
    ...
    echo "Your game has been set.  Good Luck.<a href='C5050.php'>Back</a>";
  }
}
function view_games()
{
  ...
  echo "<a href='C5050.php?add=1'>Add Game</a>Table of users awaiting a challenge<table width='75%' border='1'><tr background='header.jpg'><th>User</th><th>Cost</th><th>Prize</th><th>Challenge</th><th>Cancel</th></tr>";
...
function dogame()
{
  ...
  if(mysql_num_rows($q) > 0)
  {
    ...
    if($ir['crystals'] < $r['amount']){echo "You cannot afford the challenge amount.<a href='C5050.php'>Back</a>";exit;}
    if($ir['userid'] == $r['userID']){echo "You cannot accept your own challenge.<a href='C5050.php'>Back</a>";exit;}
  ...
  {
    echo "This game has either been cancelled or someone played before you got the 5050.<a href='C5050.php'>Back</a>"; exit;
  }
}
function cancel()
{
