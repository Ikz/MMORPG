...
{
print "<tr> <td>{$v['crimeNAME']}</td> <td>{$v['crimeBRAVE']} Brave</td> <td>{$v['crimeJAILTIME']} Minutes</td> <td> \${$v['crimeSUCCESSMUNY']} + {$v['crimeSUCCESSCRYS']} Crystals + Item: {$v['crimeSUCCESSITEM']}</td>  <td><div class='perform_btn'><a href='docrime.php?c={$v['crimeID']}'>Do</a></div></td> </tr>";
}
}
}
print "</table>";
