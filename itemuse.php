...
{
$r=$db->fetch_row($i);if($r['itmname'] == "Sunlotion")
{
$db->query("UPDATE users SET sunlotion_mins=sunlotion_mins+200 WHERE userid=$userid",$c);
print "You have stuck on your sunlotion, You will now be protected from sunburn for 200 minutes.";
$h->endpage();
exit;
}
