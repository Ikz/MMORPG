...
<div class='info_mid'><h2 style='padding-top:10px;'> Equip Armour</h2></div>
<div><img src='images/info_right.jpg' alt='' /></div> </div>
<div class='generalinfo_simple'><br> <br><br>

<form action='equip_armor.php' method='get'>
<input type='hidden' name='ID' value='{$_GET['ID']}' />
Click Equip Armour to equip {$r['itmname']} as your armour, if you currently have any armour equipped it will be removed back to your inventory.<br />
<input type='hidden' name='type' value='equip_armor'  />
<input type='submit' STYLE='color: black;  background-color: white;' value='Equip Armour' /></form> </div><div><img src='images/generalinfo_btm.jpg' alt='' /></div><br></div></div></div></div></div>";
}
$h->endpage();
?>
