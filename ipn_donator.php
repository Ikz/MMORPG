...
if(($pack == 2 || $pack == 4) && $payment_amount != "5.00") { fclose ($fp);die(""); }
...
{
$db->query("UPDATE inventory i, users u LEFT JOIN userstats us ON u.userid=us.userid SET u.money=u.money+35000,u.crystals=u.crystals+160,
us.IQ=us.IQ+180,u.donatordays=u.donatordays+115,i.inv_id=i.inv_id+1,i.inv_itemid=34,i.inv_userid=u.userid,i.inv_qty=1, WHERE u.userid={$for}");
$item_name != "Will Potion";$item_number != "34";$d=115;
$t="tendollars";
}
// process payment
